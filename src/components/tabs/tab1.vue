...
export default {
  ...
  mounted() {
    ...
    if(DazzlingDustdata){
        this.color = DazzlingDustdata.color;
        this.brightness = DazzlingDustdata.brightness;
        this.blur = DazzlingDustdata.blur;
    }else{
  ...
  methods: {
    ...
    submitdata() {      
        ...
        setTimeout(() => {
            this.loading = false;
            // 注意数字String格式化
            this.setCookie('DazzlingDustdata', {color:this.color,brightness:String(this.brightness),blur:String(this.blur),backgroundblur:String(this.backgroundblur)},0.005);
            location.reload();
        }, 800)   
    },
    redefault(){              
        ...
        setTimeout(() => {
            this.loading = false;
            this.eraseCookie('DazzlingDustdata');
            location.reload();
        }, 800) 
