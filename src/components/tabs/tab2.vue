        ...
        submitdata() {
            ...
            if(this.type == 'mobile'){
                ...
                if(DazzlingDustdatabackground){
                    this.background.pc = DazzlingDustdatabackground.pc;
                }else{
                ...
                if(DazzlingDustdatabackground){
                    this.background.mobile = DazzlingDustdatabackground.mobile;
                }else{
            ...
            setTimeout(() => {
                this.loading = false;
                this.setCookie('DazzlingDustdatabackground', this.background,0.005);
                location.reload();
            }, 800)   
        },
        redefault(){              
            ...
            setTimeout(() => {
                this.loading = false;
                this.eraseCookie('DazzlingDustdatabackground');
                location.reload();
            }, 800) 
        },
        cancel() {
...
.selectedStyle{
    border: 2px solid var(--DazzlingDust-vcard-color);
    
    box-shadow: 0 0 10px rgba(25, 118, 210, 0.5),;
}

.selected-item {
  border-color: var(--DazzlingDust-vcard-color); /* 选中时的边框颜色 */
  box-shadow: 0 0 10px var(--DazzlingDust-vcard-color); /* 选中时的阴影 */
}
</style>