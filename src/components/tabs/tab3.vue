    ...
    <v-container class="pa-0">
      ...
      <div class="pa-3">
          <div style="display: flex;width: 100%;align-items: center;">
            ...
            style="color:var(--DazzlingDust-vcard-color);"
      ...
      <v-list style="max-height: 300px;background: transparent; overflow-y: auto;" ref="songList">
        ...
        >
          <v-list-item-content class="d-flex justify-space-between">
            <v-list-item-title style="color: var(--DazzlingDust-vcard-color);">
              <span style="margin-right: 12px;">{{ index+1 }}</span>
              <span>{{ song.title }}</span>
            </v-list-item-title>
            <span style="font-size: 12px; color: var(--DazzlingDust-vcard-color);">{{ song.author }}</span>
          </v-list-item-content>
        </v-list-item>
      </v-list>
    </v-container>
